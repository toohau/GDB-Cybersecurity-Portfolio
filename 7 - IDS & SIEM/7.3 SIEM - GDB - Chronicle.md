...
* In the search bar, type `signin.office365x24.com` and click Search. Under `DOMAINS`, click signin.office365x24.com to complete the search. Below are the screenshots of the legacy view, VT, and IP address `40.100.174.34`.
  ...
  * Image 1 Legacy View
  ...
  ![7 3 SIEM - GDB - Chronicle00](https://github.com/user-attachments/assets/4ca7d5c4-27df-4de7-b54c-26b785d38055)

  * Image 2 VT 
  
  ![7 3 SIEM - GDB - Chronicle01](https://github.com/user-attachments/assets/d46ea126-6915-40ea-9140-11ffdc02077d)

  * Image 3 IP address `40.100.174.34`
  
  ![7 3 SIEM - GDB - Chronicle02](https://github.com/user-attachments/assets/a3797fd6-b75d-49ab-8506-138fd77bef9f)
